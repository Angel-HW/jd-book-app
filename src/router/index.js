    ...
    },
    {
      ...
      children: [
        ...
        // 司机我的
        {
          path: '/driver-person',
          name: 'driver-person',
          component: () => import(/* webpackChunkName: "driver-person" */ '@/pages/driver-person/index.vue'),
          meta: {
            // title: [
            //   {
            //     titleName: '负责门店信息',
        ...
        // 店长订单
        {
          path: '/shoper-order',
          name: 'shoper-order',
          component: () => import(/* webpackChunkName: "shoper-order" */ '@/pages/shoper-order/index.vue'),
          meta: {
            title: [
              {
                titleName: '我的订单',
        ...
        // 店长司机
        {
          path: '/shoper-driver',
          name: 'shoper-driver',
          component: () => import(/* webpackChunkName: "shoper-driver" */ '@/pages/shoper-driver/index.vue'),
          meta: {
            title: [
              {
                titleName: '司机信息',
                toPath: '/shoper-driver'
              }
            ],
            goBack: '/shoper-order',
            goBackShow: false,
        ...
        // 店长我的
        {
          path: '/shoper-person',
          name: 'shoper-person',
          component: () => import(/* webpackChunkName: "shoper-person" */ '@/pages/shoper-person/index.vue'),
          meta: {
            goBack: '/shoper-order',
            goBackShow: false,
            headerHide: true,
