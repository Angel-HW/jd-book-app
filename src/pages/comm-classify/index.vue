  ...
  <div class="container">
    <ul class="book-classify">
       <li
        ...
        :key="index"
        :class="{active: item.classifyId === selectClassify.classifyId}"
  ...
  methods: {
    getClassifyData () {
      req('getOneClassify', {
        ...
        // console.log(data)
        this.oneClassifyList = data.data.list
        this.selectClassify = this.oneClassifyList[0]
        this.getTwoClassify(this.selectClassify)
      })
    },
    getTwoClassify (value) {
    ...
    getCommDetail (value) {
      console.log(value)
      sessionStorage.setItem('selectComm', JSON.stringify(value))
