  ...
  <div>
    <el-container>
      <el-header height="50px" v-show="!meta.headerHide">
        <div class="user-info">
          <span class="iconfont iconzuojiantou" @click="back(userType)" v-show="meta.goBackShow"></span>
          <span
      ...
      <el-footer v-show="meta.footerShow">
        <!-- 店长 -->
        <div @click="$router.push({path: '/shoper-order'})" v-show="userType === '2'">
          <img src="../assets/u1075.png" alt="">
          <div :style="{color: currentPath === '/order-list' ? '#C39862' : '#333333'}">订单</div>
        </div>
        <div @click="$router.push({path: '/shoper-driver'})" v-show="userType === '2'">
          <img src="../assets/u1080.png" alt="">
          <div :style="{color: currentPath === '/order-list' ? '#C39862' : '#333333'}">司机</div>
        </div>
        <div @click="$router.push({path: '/shoper-person'})" v-show="userType === '2'">
          <img src="../assets/u184.png" alt="">
          <div :style="{color: currentPath === '/order-list' ? '#C39862' : '#333333'}">我的</div>
        </div>

        <!-- 司机 -->
        <div @click="$router.push({path: '/driver-home'})" v-show="userType === '3'">
          <img src="../assets/u169.png" alt="">
          <div :style="{color: currentPath === '/order-list' ? '#C39862' : '#333333'}">门店</div>
        </div>
        <div @click="$router.push({path: '/driver-person'})" v-show="userType === '3'">
          <img src="../assets/u184.png" alt="">
          <div :style="{color: currentPath === '/order-list' ? '#C39862' : '#333333'}">我的</div>
        </div>

        <!-- 用户 -->
        <div @click="$router.push({path: '/comm-home'})" v-show="userType === '4' || userType === '1'">
        ...
        <div @click="$router.push({path: '/comm-classify'})" v-show="userType === '4' || userType === '1'">
        ...
        <div @click="$router.push({path: '/shop-car'})" v-show="userType === '4' || userType === '1'">
        ...
        <div @click="$router.push({path: '/mine'})" v-show="userType === '4' || userType === '1'">
...
export default {
  ...
  methods: {
    back (userType) {
      if (userType === '2') {
        this.$router.push('/shoper-order')
      } else if (userType === '3') {
        this.$router.push('/driver-person')
      } else {
